...
class nzController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('veluojantys',$this->nzMod->getVeluojantys(5));
        $this->viewer->assign('veluojantys5',$this->nzMod->getVeluojantys5(7));
        $this->viewer->assign('jobs',$this->nzMod->getMyJobs(SESSION::getUserID()));
