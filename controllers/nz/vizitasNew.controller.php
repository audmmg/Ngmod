...
class vizitasNewController extends controller {
...
function __construct() {
    ...
    require_once ($root_pathU . "modules/nz/vizitai.mod.php");
    $this->vizitaiMod = new vizitai_mod();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('uid',$this->vizitaiMod->getDocumentNr("1"));
        $this->viewer->assign('document_nr',$this->vizitaiMod->getDocumentNr());
        $this->viewer->assign('created_by',SESSION::getUserID());
        $this->viewer->assign('neatitiktys',$this->vizitaiMod->get_neatitiktys());
        $this->viewer->assign('names',$this->asmenysMod->getNames()); 
        // Load Viewer:
        
        
        $list_html = $this->viewer->fetch('nz/vizitai/new.tpl');
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new vizitasNewController();
    $controller->run();
} else {
