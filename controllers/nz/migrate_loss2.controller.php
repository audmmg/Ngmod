...
class migrate_loss2Controller extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         echo "Migrating loss...<br />";
         $this->nzMod->migrate_loss2();
         echo "Migrating loss end...";die;
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new migrate_loss2Controller();
    $controller->run();
} else {
