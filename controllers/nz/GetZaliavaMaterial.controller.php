...
class GetZaliavaMaterialController extends controller {
...
public function showHTML() {
        ...
        $id =$this->getVar('zaliavaid');
        $rezult=$this->nzCerm->getZalDuomByMaterialID($id);
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new GetZaliavaMaterialController();
    $controller->run();
} else {
