...
class asmenysEditController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($this->getVar('save')==1)$this->asmenysMod->updateTask($this->getVar('type'));
        /*
        ...
        $this->viewer->assign('task',$this->asmenysMod->getPersonTask($this->getVar('uid'),$this->getVar('type')));
        $this->viewer->assign('type',$this->getVar('type'));
        /***teises***/
        $this->viewer->assign('is_admin',$this->teises->is_admin(SESSION::getUserID()));
        /**teises**/
        // Load Viewer:
        $list_html = $this->viewer->fetch('nz/asmenys/edit.tpl');
