...
class listPretenzijaVidineController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($this->getVar('save')==1)$this->pretenzijaMod->savePretenzija($this->getVar('p'));
        ...
        $this->viewer->assign('pretenzijos',$this->pretenzijaMod->getAllPretenzijos("1"));
        // Load Viewer:
        $list_html = $this->viewer->fetch('nz/pretenzija/vidine/list.tpl');
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new listPretenzijaVidineController();
    $controller->run();
} else {
