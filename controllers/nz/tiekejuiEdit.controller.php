...
class tiekejuiEditController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('info',$this->tiekejasMod->getEditInfo($this->getVar('uid')));
        
        $list_html = $this->viewer->fetch('nz/tiekejas/edit.tpl');
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new tiekejuiEditController();
    $controller->run();
} else {
