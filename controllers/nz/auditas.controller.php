...
class auditasController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('uid',$this->auditasMod->getDocumentNr("1"));
        $this->viewer->assign('document_nr',$this->auditasMod->getDocumentNr());
    ...
    public function getAsmenys(){
        $this->viewer->assign('list',$this->asmenysMod->asmenysList(0)); 
