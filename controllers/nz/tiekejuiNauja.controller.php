...
class tiekejuiNaujaController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('uid',$this->tiekejasMod->getDocumentNr("1"));
        $this->viewer->assign('document_nr',$this->tiekejasMod->getDocumentNr());
        $this->viewer->assign('created_by',SESSION::getUserID());
        
        $list_html = $this->viewer->fetch('nz/tiekejas/new.tpl');
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new tiekejuiNaujaController();
    $controller->run();
} else {
