...
class pretenzijaEditVidineController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('info',$this->pretenzijaMod->getPretenzijaInfo($this->getVar('uid'),"1"));
    ...
    public function getAsmenys(){
        $this->viewer->assign('list',$this->asmenysMod->asmenysList(2)); 
        $this->viewer->assign('names',$this->asmenysMod->getNames()); 
        $this->viewer->assign('type',2); 
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new pretenzijaEditVidineController();
    $controller->run();
} else {
