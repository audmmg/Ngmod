...
class vizitasEditController extends controller {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->viewer->assign('info',$this->vizitaiMod->getInfo($this->getVar('uid')));
        ...
        $list_html = $this->viewer->fetch('nz/vizitai/edit.tpl');
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new vizitasEditController();
    $controller->run();
} else {
