...
class uzsakymoInformacijaController extends controller {
...
public function showHTML() {
        ...
        $rezult=$this->nzCerm->getJobDuomByJobID($id);
        $this->viewer->assign('duomenys',$rezult);//$this->var_dump($rezult);die;
        $this->viewer->assign('names',$this->asmenysMod->getNames()); 
        $list_html = $this->viewer->fetch('nz/pretenzija/uzsakymo_info.tpl');  
        echo $list_html;die;
    }
...
if (@$_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest') {
    $controller = new uzsakymoInformacijaController();
    $controller->run();
} else {
